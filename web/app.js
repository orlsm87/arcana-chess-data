...
const TRANSLATIONS = {
  es: {
    ...
    badge_eng: "💻 Ing. en Sistemas de Información",
    badge_ped: "🎓 Mtro. en Pedagogía y Práctica Docente",
    badge_doc: "🔬 Dr. en Investigación para la Educación",
    ...
    manifesto_p1: "Cualquiera que haya competido en ajedrez de alto rendimiento o haya tenido alumnos a su cargo conoce esta verdad. Como ajedrecista titulado pero también desde mi formación como <strong>Ingeniero en Sistemas de Información, Maestro en Pedagogía y Doctor en Investigación para la Educación</strong>, la conclusión es tajante: <strong>la gestión caótica y los monopolios cerrados de bases de datos son una pesadilla técnica y una barrera injusta para el aprendizaje</strong>.",
    ...
    card2_desc: "Todas las partidas históricas en formato estándar PGN compatible con cualquier software de ajedrez (ChessBase, SCID, Fritz, Lichess, Chess.com y próximamente Arcana Chess Studio).",
  ...
  en: {
    ...
    badge_ft: "FT • FIDE Trainer",
    badge_nm: "NM • National Master",
    badge_eng: "💻 Information Systems Engineer",
    badge_ped: "🎓 M.Ed. in Pedagogy & Teaching Practice",
    badge_doc: "🔬 Ph.D. in Educational Research",
    ...
    manifesto_p1: "Anyone who has competed in high-level tournament chess or trained students knows this truth. As a titled chess master and coach, but equally through my lens as an <strong>Information Systems Engineer, Master in Pedagogy & Teaching Practice, and Ph.D. in Educational Research</strong>, the conclusion is undeniable: <strong>the proprietary lock-in and chaotic management of chess databases is both a technical nightmare and an unfair barrier to learning</strong>.",
    ...
    card2_desc: "Complete historical collection in standard PGN format compatible with all chess software (ChessBase, SCID, Fritz, Lichess, Chess.com, and coming soon Arcana Chess Studio).",
